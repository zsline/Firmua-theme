...
function Edit({
  ...
  const uid = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(() => `id-${Date.now()}-${Math.random().toString(36).slice(2, 9)}`, []);
  ...
  const duplicateItem = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(index => {
  ...
  const updateItem = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)((index, field, value) => {
    const copy = (items || []).map((it, i) => i === index ? {
      ...it,
      [field]: value
    } : it);
    setAttributes({
  ...
  const removeItem = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(index => {
    setAttributes({
      items: (items || []).filter((_, i) => i !== index)
    });
  }, [items, setAttributes]);
  // =======================================================================
  const addTab = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(itemIndex => {
    // Разрешаем только кастомные post type + стандартные post/page
    const allowedPostTypes = (postTypes || []).filter(type => type.slug === 'post' || type.slug === 'page' || !['attachment', 'wp_block', 'wp_template', 'wp_template_part', 'wp_navigation', 'wp_font_family', 'wp_font_face', 'wp_global_styles', 'wp_pattern', 'wp_navigation'].includes(type.slug));
    const defaultPostType = allowedPostTypes.find(t => t.slug === 'post')?.slug || allowedPostTypes[0]?.slug || 'post';
  ...
  const updateTab = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)((itemIndex, tabIndex, field, value) => {
    const copy = (items || []).map((it, i) => {
      if (i !== itemIndex) return it;
      const tabs = (it.tabs || []).map((t, ti) => {
        ...
        const updated = {
          ...t,
          [field]: field === 'termId' && value !== '' ? parseInt(value, 10) : value
        };
        if (field === 'postType') {
          updated.taxonomy = '';
          updated.termId = '';
  ...
  const removeTab = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)((itemIndex, tabIndex) => {
    const copy = (items || []).map((it, i) => {
      if (i !== itemIndex) return it;
  ...
  const onItemsDragEnd = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)(event => {
    const {
      active,
      over
    } = event;
    ...
    const moved = (0,_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_5__.arrayMove)(items, oldIndex, newIndex);
    setAttributes({
      items: moved
    });
  }, [items, setAttributes]);
  const onTabsDragEnd = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useCallback)((event, itemIndex) => {
    const {
      active,
      over
    } = event;
    ...
    copy[itemIndex] = {
      ...copy[itemIndex],
      tabs: (0,_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_5__.arrayMove)(tabs, oldIndex, newIndex)
    };
    setAttributes({
      items: copy
    });
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_dnd_kit_core__WEBPACK_IMPORTED_MODULE_4__.DndContext, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_5__.SortableContext, {
        ...
        children: items.map((item, itemIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(SortableItem, {
          id: item.id,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.RichText, {
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_dnd_kit_core__WEBPACK_IMPORTED_MODULE_4__.DndContext, {
              sensors: sensors,
              collisionDetection: _dnd_kit_core__WEBPACK_IMPORTED_MODULE_4__.closestCenter,
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_5__.SortableContext, {
                ...
                strategy: _dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_5__.verticalListSortingStrategy,
                children: (item.tabs || []).map((tab, tabIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(SortableItem, {
                  id: tab.id,
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(TabEditor, {
                    tab: tab,
                    postTypes: postTypes,
...
function TabEditor({
  ...
  const taxonomies = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    const all = select('core').getTaxonomies() || [];
    return all.filter(t => (t.types || []).includes(tab.postType));
  }, [tab.postType]);
  const terms = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
      label: "Post type",
      value: tab.postType,
      options: (postTypes || []).filter(pt => pt.slug === 'post' || pt.slug === 'page' || !['attachment', 'wp_block', 'wp_template', 'wp_template_part', 'wp_navigation', 'wp_font_family', 'nav_menu_item', 'wp_font_face', 'wp_global_styles', 'wp_pattern'].includes(pt.slug)).map(pt => ({
        label: pt.name,
        value: pt.slug
      })),
    ...
    }), !!tab.taxonomy && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
      label: "Category / Term",
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/hero-home/edit.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/hero-home/style.scss");



(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('firm-blocks/hero-home', {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["hero-home/style-index"], () => (__webpack_require__("./src/hero-home/index.js")))
