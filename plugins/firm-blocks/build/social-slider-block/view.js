/******/ (() => { // webpackBootstrap
/*!*****************************************!*\
  !*** ./src/social-slider-block/view.js ***!
  \*****************************************/
document.addEventListener('DOMContentLoaded', () => {
  const sliders = document.querySelectorAll('.wp-block-firm-blocks-social-slider-block .item-content__slider[data-items]');
  sliders.forEach(slider => {
    ...
    items.forEach(it => {
      ...
      slide.className = 'item-content__slide social-item swiper-slide';
